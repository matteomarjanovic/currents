<script lang="ts">
	...
	let selectedCollectionUri = $derived(userPickedUri ?? defaultCollectionUri(clipper.collections));
		...
		>
			...
			{:else}
				...
				<div class="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto">
					...
					<span class="-mb-1 text-xs text-muted-foreground">Apply labels:</span>
