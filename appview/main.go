...
func runServer(cctx *cli.Context) error {
	...
	http.HandleFunc("GET /xrpc/is.currents.feed.getUnsortedSaves", srv.XRPCGetUnsortedSaves)
	http.HandleFunc("GET /xrpc/is.currents.feed.getLibrarySaves", srv.XRPCGetLibrarySaves)
	...
	http.HandleFunc("GET /xrpc/is.currents.graph.getFavouriteCollections", srv.XRPCGetFavouriteCollections)
