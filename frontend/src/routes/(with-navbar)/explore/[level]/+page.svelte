...
<PullToRefresh label="feed" disabled={feed.loading} onRefresh={refreshFeed} />
...
<div
	class="fixed right-[calc(0.5rem+var(--sb)+100%-100vw)] bottom-[calc(env(safe-area-inset-bottom)+0.875rem)] z-20 flex md:right-[calc(1rem+var(--sb)+100%-100vw)]"
