...
<div class={cn('bg-popover flex w-[350px] flex-col gap-3 rounded-lg border p-3 shadow-sm', className)}>
	...
	<div class="flex items-center gap-3">
		<div
			class="relative mt-1 h-8 w-8 shrink-0 overflow-hidden rounded-md border shadow-sm bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMUlEQVQ4T2NkYGAQYcAP3uCTZhw1gGGYhAGBZIA/nYDCgBDAm9BGDWAAJyRCgLaBCAAgXwixzAS0pgAAAABJRU5ErkJggg==')]"
		>
		...
		<div class="flex flex-1 flex-col justify-center gap-3">
			...
			{#if allowOpacity}
				<div
					bind:this={alphaRef}
					class="relative h-3 w-full cursor-pointer touch-none rounded-full shadow-sm ring-1 ring-black/5 bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMUlEQVQ4T2NkYGAQYcAP3uCTZhw1gGGYhAGBZIA/nYDCgBDAm9BGDWAAJyRCgLaBCAAgXwixzAS0pgAAAABJRU5ErkJggg==')]"
					role="slider"
					aria-valuenow={a}
					tabindex="0"
