<script lang="ts">
	...
	function onSubmitCustom(e: Event) {
		e.preventDefault();
			...
			<FieldGroup>
				<Field>
					<Button
						...
						class="w-full"
						disabled={inFlight}
						onclick={() => startLogin('https://bsky.social')}
					>
						<svg
					...
					<Button
						...
						class="w-full"
						disabled={inFlight}
						onclick={() => startLogin('https://eurosky.social')}
					>
						<svg
					...
					<Button
						...
						class="w-full"
						disabled={inFlight}
						onclick={() => startLogin('https://blacksky.app')}
					>
				...
				<form onsubmit={onSubmitCustom}>
					<FieldGroup>
						...
						<Field>
							<Button type="submit" class="w-full" disabled={inFlight}>Login</Button>
