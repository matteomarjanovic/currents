<script lang="ts">
	...
	function goBack() {
		// Back means browser Back, including returning to the external page that opened Currents.
		// Only use the Explore fallback when this tab truly has no previous history entry.
