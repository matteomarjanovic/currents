...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapawesomeCapacitorAccessibilityPreferences", path: "../../../node_modules/@capawesome/capacitor-accessibility-preferences"),
        ...
        .package(name: "CapawesomeTeamCapacitorSecurePreferences", path: "../../../node_modules/@capawesome-team/capacitor-secure-preferences"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "CapawesomeTeamCapacitorSecurePreferences", package: "CapawesomeTeamCapacitorSecurePreferences"),
